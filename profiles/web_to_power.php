 ...
 */
return [
    'description' => 'Apply WebApp IR heuristics (labels, layout/state, renames, Navigate/SetFocus), restore classic ScaleToFit, then fill a11y labels / focus ring / tab index / tooltips.',
    'hops' => [
